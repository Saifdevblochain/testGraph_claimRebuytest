...
export class rebuyClaims__roundsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class rebuyClaims extends ethereum.SmartContract {
  static bind(address: Address): rebuyClaims {
    return new rebuyClaims("rebuyClaims", address);
  }
  ...
  rounds(param0: i32): rebuyClaims__roundsResult {
    let result = super.call(
      "rounds",
    ...
    return new rebuyClaims__roundsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_rounds(param0: i32): ethereum.CallResult<rebuyClaims__roundsResult> {
    let result = super.tryCall(
      "rounds",
      "rounds(uint8):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0))]
